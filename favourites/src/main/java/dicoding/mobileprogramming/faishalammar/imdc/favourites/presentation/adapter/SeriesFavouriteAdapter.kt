...
class SeriesFavouriteAdapter(val appContext: Context) : RecyclerView.Adapter<SeriesFavouriteAdapter.FilmViewHolder>() {

    private lateinit var onItemClickCallback: OnItemClickCallback
    private var _binding: FilmFavouriteRowBinding? = null
    private val binding get() = _binding!!
    private val listFavouriteSeries : ArrayList<Series> = ArrayList()

    fun setData(items: ArrayList<Series>) {
        listFavouriteSeries.clear()
        listFavouriteSeries.addAll(items)
    ...
    override fun onBindViewHolder(holder: FilmViewHolder, position: Int) {
        val film = listFavouriteSeries[position]
        ...
        holder.deleteButton.setOnClickListener{
            listFavouriteSeries.removeAt(position)
            notifyDataSetChanged()
    ...
    interface OnItemClickCallback {
        ...
        fun onDeleteButtonClicked(film: Series)
    }

    override fun getItemCount(): Int {
        return listFavouriteSeries.size
    }
